...
public abstract class AbstractImmutableSetTestCase extends AbstractImmutableCollectionTestCase
{
    ...
    public void newWithAll()
    {
        ...
        Assertions.assertEquals(UnifiedSet.newSet(set).with(0), withAll);
    }
    ...
    public void newWithoutAll()
    {
        ...
        Assertions.assertEquals(set, largeWithoutAll3);
    }
    ...
    public void contains()
    {
        ...
        Assertions.assertFalse(set.contains(set.size() + 1));
    }
    ...
    public void select_target()
    {
        ...
        Assertions.assertEquals(integers, integers.select(Predicates.lessThan(integers.size() + 1), UnifiedSet.<Integer>newSet()));
    ...
    public void reject_target()
    {
        ...
        Assertions.assertEquals(integers, integers.reject(Predicates.greaterThan(integers.size()), UnifiedSet.<Integer>newSet()));
    }
    ...
    public void zip()
    {
        ...
        Assertions.assertEquals(immutableCollection.zip(nulls), immutableCollection.zip(nulls, UnifiedSet.<Pair<Integer, Object>>newSet()));
    }
    ...
    {
        ImmutableCollection<Integer> integers = this.classUnderTest();
        Assertions.assertEquals(integers, integers.collectIf(Integer.class::isInstance, Functions.getIntegerPassThru(), UnifiedSet.<Integer>newSet()));
    }
    ...
    public void toSortedListBy()
    {
        ...
        Assertions.assertEquals(this.classUnderTest().toList(), list);
    }
