...
public class CollectIterableTest extends AbstractLazyIterableTestCase
{
    ...
    public void injectIntoDouble()
    {
        ...
        Assertions.assertEquals(7.2, sum, 0.1);
    }
    ...
    public void getFirstOnEmpty()
    {
        ...
        Assertions.assertNull(collect.getFirst());
    }
    ...
    {
        CollectIterable<Integer, String> collect = new CollectIterable<>(FastList.newList(), String::valueOf);
        Assertions.assertNull(collect.getLast());
    }
    ...
    public void toArray()
    {
        ...
        stringNums.toArray();
        Assertions.assertEquals(Lists.immutable.of("0", "1", "2", "3"), Lists.immutable.ofAll(stringNums));
    }
}
