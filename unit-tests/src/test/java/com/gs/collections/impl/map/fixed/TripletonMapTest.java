...
public class TripletonMapTest extends AbstractMemoryEfficientMutableMapTest
{
    ...
    public void flip()
    {
        ...
        Assertions.assertEquals(Multimaps.immutable.set.with(1, "A", 2, "B", 3, "C"), flipZero);
        Assertions.assertEquals(Multimaps.immutable.set.with(1, "A", 1, "B", 3, "C"), flipOne);
        Assertions.assertEquals(Multimaps.immutable.set.with(1, "A", 1, "B", 1, "C"), flipTwo);
        ...
        Assertions.assertEquals(Multimaps.immutable.set.with(1, "A", 1, "B", null, "C"), flipNull);
        ...
        Assertions.assertEquals(Multimaps.immutable.set.with(null, "A", null, "B", null, "C"), flipNullAllNull);
    }
    ...
    public void forEachKeyValue()
    {
        ...
        Assertions.assertEquals(FastList.newListWith("1One", "2Two", "3Three"), collection);
    }
    ...
    public void flipUniqueValues()
    {
        ...
        Assertions.assertEquals(UnifiedMap.newWithKeysValues("One", 1, "Two", 2, "Three", 3), flip);
    ...
    public void nonUniqueWithKeyValue()
    {
        ...
        Assertions.assertSame(map.getKey3(), twin3);
        Assertions.assertSame(map.get(twin1), twin4);
        Assertions.assertSame(map.get(twin2), twin5);
        Assertions.assertSame(map.get(twin3), twin6);
    }
    ...
    {
        Assertions.assertTrue(new TripletonMap<>(1, "1", 2, "2", 3, "3").notEmpty());
    }
    ...
    public void select()
    {
        ...
        Assertions.assertEquals(new SingletonMap<>("3", "Three"), three);
        ...
        Assertions.assertEquals(new DoubletonMap<>("1", "One", "3", "Three"), oneAndThree);
        ...
        Assertions.assertEquals(new DoubletonMap<>("1", "One", "2", "Two"), oneAndTwo);
        ...
        Assertions.assertEquals(new DoubletonMap<>("2", "Two", "3", "Three"), twoAndThree);
    }
    ...
    public void detect()
    {
        ...
        Assertions.assertEquals(Tuples.pair("3", "Three"), three);
    ...
    {
        Assertions.assertEquals(FastList.newListWith("1", "2", "3"), this.classUnderTest().keysView().toSortedList());
    }
    ...
    {
        Assertions.assertEquals(Bags.mutable.of("One", "Two", "Three"), this.classUnderTest().valuesView().toBag());
    }
}
