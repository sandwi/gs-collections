...
public abstract class AbstractImmutableMultimapTestCase
{
    ...
    public void get()
    {
        ...
        Assertions.assertEquals(FastList.newListWith("1"), notEmptyView.toList());
    }
    ...
    {
        ImmutableMultimap<String, String> empty = this.classUnderTest();
        Assertions.assertEquals(UnifiedMap.<String, RichIterable<String>>newMap(), empty.toMap());
    ...
    public void newWithAll_newWithoutAll()
    {
        ...
        Assertions.assertEquals(empty.newWithAll("1", FastList.newListWith("1", "2")), notEmpty);
    ...
    {
        ImmutableMultimap<String, String> empty = this.classUnderTest();
        Assertions.assertSame(empty, empty.toImmutable());
    }
    ...
    public void selectKeysValues()
    {
        ...
        Assertions.assertEquals(this.classUnderTest().newWith("Two", "2"), selectedMultimap);
    }
    ...
    public void rejectKeysValues()
    {
        ...
        Assertions.assertEquals(this.classUnderTest().newWith("One", "1"), rejectedMultimap);
    }
    ...
    public void selectKeysMultiValues()
    {
        ...
        Assertions.assertEquals(this.classUnderTest().newWith("Two", "2").newWith("Two", "3"), selectedMultimap1);
        ...
        Assertions.assertEquals(this.classUnderTest(), selectedMultimap2);
    }
    ...
    public void rejectKeysMultiValues()
    {
        ...
        Assertions.assertEquals(this.classUnderTest().newWith("One", "1"), rejectedMultimap1);
        ...
        Assertions.assertEquals(this.classUnderTest().newWith("One", "1"), rejectedMultimap2);
    }
    ...
    public void collectKeysValues()
    {
        ...
        Assertions.assertEquals(this.classUnderTest().newWith("OneKey", "1Value").newWith("TwoKey", "2Value"), collectedMultimap);
    }
    ...
    public void collectValues()
    {
        ...
        Assertions.assertEquals(this.classUnderTest().newWith("One", "1Value").newWith("Two", "2Value"), collectedMultimap);
    }
