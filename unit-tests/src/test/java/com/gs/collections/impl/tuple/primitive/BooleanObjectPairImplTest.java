...
public class BooleanObjectPairImplTest
{
    ...
    public void getTwo()
    {
        Assertions.assertEquals("true", PrimitiveTuples.pair(false, "true").getTwo());
        Assertions.assertEquals("false", PrimitiveTuples.pair(true, "false").getTwo());
    }
    ...
    public void compareTo()
    {
        ...
        Assertions.assertEquals(-1, PrimitiveTuples.pair(false, "false").compareTo(PrimitiveTuples.pair(true, "true")));
    }
}
