...
public class TakeIterableTest extends AbstractLazyIterableTestCase
{
    ...
    public void basic()
    {
        Assertions.assertEquals(2, this.takeIterable.size());
        Assertions.assertEquals(FastList.newListWith(1, 2), this.takeIterable.toList());

        Assertions.assertEquals(0, this.emptyListTakeIterable.size());
        Assertions.assertEquals(0, this.zeroCountTakeIterable.size());
        Assertions.assertEquals(5, this.higherCountTakeIterable.size());
        Assertions.assertEquals(5, this.sameCountTakeIterable.size());
    }
    ...
    public void forEachWithIndex()
    {
        ...
        Assertions.assertEquals(FastList.newListWith(0, 1), indices);
    ...
    public void forEachWith()
    {
        ...
        Assertions.assertEquals(3, sum1.getValue().intValue());
