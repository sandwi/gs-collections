...
public class IterableIterateTest
{
    ...
    public void injectIntoOver30()
    {
        ...
        Assertions.assertEquals(32, Iterate.injectInto(1, iterable, AddFunction.INTEGER).intValue());
    }
    ...
    public void injectIntoString()
    {
        ...
        Assertions.assertEquals("0123", Iterate.injectInto("0", iterable, AddFunction.STRING));
    }
    ...
    public void injectIntoMaxString()
    {
        ...
        Assertions.assertEquals(3, Iterate.injectInto(Integer.MIN_VALUE, iterable, MaxSizeFunction.STRING).intValue());
    }
    ...
    {
        Iterable<String> iterable = new IterableAdapter<>(iList("1", "12", "123"));
        Assertions.assertEquals(1, Iterate.injectInto(Integer.MAX_VALUE, iterable, MinSizeFunction.STRING).intValue());
    }
    ...
    public void collect()
    {
        ...
        Assertions.assertEquals(iList("true", "false", "null"), result);
    }
    ...
    public void collectOver30()
    {
        ...
        Assertions.assertEquals(Collections.nCopies(31, Integer.class), result);
    }
    ...
    public void forEachWithIndex()
    {
        ...
        Iterate.forEachWithIndex(iterable, (object, index) -> Assertions.assertEquals(index, object - 1));
    }
    ...
    public void detect()
    {
        ...
        Assertions.assertEquals(1, Iterate.detect(iterable, Integer.valueOf(1)::equals).intValue());
        //noinspection CachedNumberConstructorCall,UnnecessaryBoxing
        Integer firstInt = Integer.valueOf(2);
        //noinspection CachedNumberConstructorCall,UnnecessaryBoxing
        Integer secondInt = Integer.valueOf(2);
        Assertions.assertNotSame(firstInt, secondInt);
        ImmutableList<Integer> list2 = iList(1, firstInt, secondInt);
        Assertions.assertSame(list2.get(1), Iterate.detect(list2, Integer.valueOf(2)::equals));
    }
    ...
    {
        Iterable<Integer> iterable = new IterableAdapter<>(this.getIntegerList());
        Assertions.assertEquals(1, Iterate.detectWith(iterable, Object::equals, 1).intValue());
        //noinspection CachedNumberConstructorCall,UnnecessaryBoxing
        Integer firstInt = Integer.valueOf(2);
        //noinspection CachedNumberConstructorCall,UnnecessaryBoxing
        Integer secondInt = Integer.valueOf(2);
        Assertions.assertNotSame(firstInt, secondInt);
        ImmutableList<Integer> list2 = iList(1, firstInt, secondInt);
        Assertions.assertSame(list2.get(1), Iterate.detectWith(list2, Object::equals, 2));
    }
    ...
    {
        Iterable<Integer> iterable = new IterableAdapter<>(this.getIntegerList());
        Assertions.assertNull(Iterate.detectIfNone(iterable, Integer.valueOf(6)::equals, null));
    }
    ...
    {
        Iterable<Integer> iterable = new IterableAdapter<>(Interval.oneTo(31));
        Assertions.assertNull(Iterate.detectIfNone(iterable, Integer.valueOf(32)::equals, null));
    }
    ...
    {
        Iterable<Integer> iterable = new IterableAdapter<>(this.getIntegerList());
        Assertions.assertNull(Iterate.detectWithIfNone(iterable, Object::equals, 6, null));
    }
    ...
    {
        Iterable<Integer> iterable = new IterableAdapter<>(Interval.oneTo(31));
        Assertions.assertNull(Iterate.detectWithIfNone(iterable, Object::equals, 32, null));
    }
    ...
    public void distinct()
    {
        ...
        Assertions.assertEquals(result2, FastList.newListWith(1, 2, 5, 7, 4));
        ...
        Assertions.assertEquals(result3, FastList.newListWith(1, 2));
        ...
        Assertions.assertEquals(result4, FastList.newListWith(2, 4, 5));
    }
    ...
    public void selectInstancesOf()
    {
        ...
        Assertions.assertEquals(iList(1, 3, 5), result);
    }
    ...
    public void selectAndRejectWith()
    {
        ...
        Assertions.assertEquals(iList(1), result.getOne());
        Assertions.assertEquals(iList(5, 4, 3, 2), result.getTwo());
    }
    ...
    public void partition()
    {
        ...
        Assertions.assertEquals(iList(4, 2), partition.getSelected());
        Assertions.assertEquals(iList(5, 3, 1), partition.getRejected());
    }
    ...
    {
        Iterable<Integer> iterable = new IterableAdapter<>(this.getIntegerList());
        Assertions.assertTrue(Iterate.anySatisfyWith(iterable, Predicates2.instanceOf(), Integer.class));
        Assertions.assertFalse(Iterate.anySatisfyWith(iterable, Predicates2.instanceOf(), Double.class));
    }
    ...
    {
        Iterable<Integer> iterable = new IterableAdapter<>(this.getIntegerList());
        Assertions.assertTrue(Iterate.anySatisfy(iterable, Integer.class::isInstance));
        Assertions.assertFalse(Iterate.anySatisfy(iterable, Double.class::isInstance));
    }
    ...
    {
        Iterable<Integer> iterable = new IterableAdapter<>(this.getIntegerList());
        Assertions.assertTrue(Iterate.allSatisfyWith(iterable, Predicates2.instanceOf(), Integer.class));
        Assertions.assertFalse(Iterate.allSatisfyWith(iterable, Predicates2.<Integer>greaterThan(), 2));
    }
    ...
    {
        Iterable<Integer> iterable = new IterableAdapter<>(this.getIntegerList());
        Assertions.assertTrue(Iterate.allSatisfy(iterable, Integer.class::isInstance));
        Assertions.assertFalse(Iterate.allSatisfy(iterable, Predicates.greaterThan(2)));
    }
    ...
    {
        Iterable<Integer> iterable = new IterableAdapter<>(this.getIntegerList());
        Assertions.assertTrue(Iterate.noneSatisfy(iterable, String.class::isInstance));
        Assertions.assertFalse(Iterate.noneSatisfy(iterable, Predicates.greaterThan(0)));
    }
    ...
    {
        Iterable<Integer> iterable = new IterableAdapter<>(this.getIntegerList());
        Assertions.assertTrue(Iterate.noneSatisfyWith(iterable, Predicates2.instanceOf(), String.class));
        Assertions.assertFalse(Iterate.noneSatisfyWith(iterable, Predicates2.<Integer>greaterThan(), 0));
    }
    ...
    {
        Iterable<Integer> iterable = new IterableAdapter<>(this.getIntegerList());
        Assertions.assertEquals(5, Iterate.countWith(iterable, Predicates2.instanceOf(), Integer.class));
        Assertions.assertEquals(0, Iterate.countWith(iterable, Predicates2.instanceOf(), Double.class));
    }
    ...
    public void selectWithRandomAccess()
    {
        ...
        Assertions.assertEquals(iList(5, 4, 3, 2, 1), results);
    ...
    public void collectIf()
    {
        ...
        Assertions.assertEquals(iList(Integer.class), result);
    }
    ...
    public void detectIndexOver30()
    {
        ...
        Iterable<Integer> iterable = new IterableAdapter<>(list);
        Assertions.assertEquals(30, Iterate.detectIndex(iterable, Integer.valueOf(1)::equals));
        Assertions.assertEquals(0, Iterate.detectIndex(iterable, Integer.valueOf(31)::equals));
    }
    ...
    public void detectIndexWithOver30()
    {
        MutableList<Integer> list = Interval.toReverseList(1, 31);
        Iterable<Integer> iterable = new IterableAdapter<>(list);
        Assertions.assertEquals(30, Iterate.detectIndexWith(iterable, Object::equals, 1));
        Assertions.assertEquals(0, Iterate.detectIndexWith(iterable, Object::equals, 31));
    }
    ...
    public void removeIfWith()
    {
        ...
        Assertions.assertEquals(iList(1, 2, 3), objects1);
        ...
        Assertions.assertEquals(iList(1, 2, 3), objects2);

        MutableList<Integer> objects3 = mList(1, null, 2, 3);
        Iterable<Integer> iterable3 = new IterableAdapter<>(objects3);
        Iterate.removeIfWith(iterable3, (each3, ignored3) -> each3 == null, null);
        Assertions.assertEquals(iList(1, 2, 3), objects3);
        ...
        Assertions.assertEquals(iList(1, 2, 3), objects5);
        ...
        Assertions.assertEquals(iList(1, 2, 3), objects6);
    }
    ...
    public void forEach()
    {
        ...
        Assertions.assertEquals(Interval.oneTo(10), newCollection);
    }
    ...
    public void take()
    {
        ...
        Assertions.assertEquals(FastList.newListWith(5), Iterate.take(iterable, 1));
        Assertions.assertEquals(FastList.newListWith(5, 4), Iterate.take(iterable, 2));
        Assertions.assertEquals(list, Iterate.take(iterable, 5));
        Assertions.assertEquals(list, Iterate.take(iterable, 6));
        Assertions.assertEquals(list, Iterate.take(iterable, Integer.MAX_VALUE));
        Assertions.assertNotSame(iterable, Iterate.take(iterable, Integer.MAX_VALUE));
    }
    ...
    public void drop()
    {
        List<Integer> list = this.getIntegerList();
        Iterable<Integer> iterable = new IterableAdapter<>(list);
        Assertions.assertEquals(FastList.newListWith(5, 4, 3, 2, 1), Iterate.drop(iterable, 0));
        Assertions.assertEquals(FastList.newListWith(4, 3, 2, 1), Iterate.drop(iterable, 1));
        Assertions.assertEquals(FastList.newListWith(3, 2, 1), Iterate.drop(iterable, 2));
        Assertions.assertEquals(FastList.newListWith(1), Iterate.drop(iterable, 4));
    ...
    public void maxWithoutComparator()
    {
        ...
        Assertions.assertEquals(99, IterableIterate.max(iterable).intValue());
    }
    ...
    public void minWithoutComparator()
    {
        ...
        Assertions.assertEquals(1, IterableIterate.min(iterable).intValue());
    }
    ...
    {
        Iterable<Integer> iterable = FastList.newListWith(1, 5, 2, 99, 7);
        Assertions.assertEquals(99, IterableIterate.max(iterable, Integer::compareTo).intValue());
    }
    ...
    {
        Iterable<Integer> iterable = FastList.newListWith(99, 5, 2, 1, 7);
        Assertions.assertEquals(1, IterableIterate.min(iterable, Integer::compareTo).intValue());
    }
