...
public class ImmutableBagMultimapTest extends AbstractImmutableMultimapTestCase
{
    ...
    public void forEachKeyMultiValue()
    {
        ...
        Assertions.assertEquals(UnifiedSet.newSetWith(Tuples.pair("Two", HashBag.newBagWith(2, 1)), Tuples.pair("Three", HashBag.newBagWith(3, 3))), collection);
    }
    ...
    public void collectKeysValues()
    {
        ...
        Assertions.assertEquals(expectedImmutableMultimap1, collectedMultimap);
