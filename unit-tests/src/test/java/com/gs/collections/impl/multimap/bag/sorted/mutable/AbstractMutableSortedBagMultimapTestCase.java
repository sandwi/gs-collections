...
public abstract class AbstractMutableSortedBagMultimapTestCase extends AbstractMutableMultimapTestCase
{
    ...
    public void toImmutable()
    {
        ...
        Assertions.assertFalse(this.newMultimap().toImmutable() instanceof MutableSortedBagMultimap);
    }
    ...
    public void rejectKeysValues()
    {
        ...
        Assertions.assertSame(expectedMultimap.comparator(), rejectedMultimap.comparator());
    }
